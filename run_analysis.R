...
# No additional steps since it was done in the previous steps (1.3, 2.2, and 2.3)
...
# 5.2 Writing the second tidy data set to a txt file
write.table(secTidySet, "MyTidyDataset.txt", row.name = FALSE)